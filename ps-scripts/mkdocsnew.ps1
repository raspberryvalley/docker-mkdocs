...
=======================
This script creates a new mkdocs site using the raspberryvalley/mkdocs image (version 1.2.0)
...
$command = "docker run -it --rm -v $(pwd):/mysite raspberryvalley/mkdocs:1.2.0 new ."
